...
整个系统跑在客户自己的 VPS 上，**客户老板能在 N8N 画布看到每一步流程**，**审核员可以在飞书多维表或本地 5001 演示入口完成录入与审核演示**，**新 SKU 上来时只录一份资料**就能跑完整条链路。
...
| 视频生成 | Seedance image-to-video（火山引擎方舟） | 与视频项目方案 4 复用 |
...
curl -X POST https://api.<你的域名>/webhook/trigger/image \
    ...
    -d '{"task_id": "55555555-5555-5555-5555-555555555501"}'
```
